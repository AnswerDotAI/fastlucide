...
# %% auto 0
__all__ = ['read_icons', 'sz_attrs', 'symbol', 'sprites', 'icon', 'SvgStyle', 'SvgSprites', 'combined']
...
def combined(
    ...
    **kw # Additional attrs for svg
    ...
    trans = ''
    sz, vbox = kw.pop('sz', ss.sz), kw.pop('vbox', ss.vbox)
    if position == 'overlap':
        szx = szy = sz
        vx  = vy  = vbox
    ...
    return Svg(Use(href=f"#{ss.pre}{nm1}"),
               Use(href=f"#{ss.pre}{nm2}", transform=trans),
